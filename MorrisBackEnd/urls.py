...
urlpatterns = [
    ...
    re_path('^api/schedule/(.*?)/$', views.ScheduleView.as_view()),
    path('api/work/', views.WorkView.as_view()),
    re_path('^api/billing/(.*?)/$', views.BillingAccountView.as_view()),
    path('api/billing/', views.BillingAccountListView.as_view()),
    path('api/hcp/billings/', views.HcpBillingListView.as_view()),
    re_path('^api/hcp/billing/(.*?)/$', views.HcpBillingView.as_view()),
    re_path('^api/hcp/pay/(.*?)/$', views.HcpPayView.as_view()),
    re_path('^api/pay/(.*?)/$', views.PayView.as_view()),
